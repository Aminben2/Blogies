...
const About = () => {
  ...
  return (
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 bg-gray-50 dark:bg-gray-700">
      <p className="font-normal text-sm leading-3 text-green-600 hover:text-green-700 cursor-pointer pb-2">
        About
      </p>
      <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
        <div className="w-full lg:w-6/12">
          <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9 dark:text-gray-100">
            Empowering everyone to create stunning blogs effortlessly
          </h2>
          <p className="font-normal text-base leading-6 text-gray-600 mt-6 dark:text-gray-300">
            Celebrating the art of storytelling, our platform is a haven for
            creators of all backgrounds. We believe in the power of words to
            connect, inspire, and transform lives. Whether you're a seasoned
            writer or just starting your journey, our community welcomes you
            with open arms. Join us as we embark on a collective journey of
            self-expression, discovery, and meaningful connections. Together,
            let's explore the endless possibilities of storytelling and create a
            world where every voice is heard and valued
          </p>
        </div>
        <div className="w-full lg:w-6/12">
          <img
      ...
      <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
        <div>
          <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6 dark:text-gray-100">
            Founded
          </p>
          <p className="font-normal text-base leading-6 text-gray-600 mt-6 dark:text-gray-300">
            Born from a desire to democratize blogging, we launched in [insert
            founding year] to provide a welcoming space for diverse voices.
            Since then, we've remained dedicated to empowering creators
            worldwide.
          </p>
        </div>
        <div>
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6 dark:text-gray-300">
            With 50 million monthly enrichments, our platform thrives on
            constant engagement, empowering users to interact, create, and
        ...
        <div className="sm:block hidden">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6 dark:text-gray-300">
            Our platform boasts 400k users, each adding their unique voice to
            our diverse community, enriching our collective experience.
          </p>
        </div>
      </div>
      ...
      <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
        <div className="w-full lg:w-6/12">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12 dark:text-gray-300">
            At our core, we are driven by a singular mission: to empower
            individuals worldwide to share their stories, passions, and
            perspectives with the world. Through our platform, we strive to
            democratize access to the tools and resources needed for creative
            expression, fostering a global community of voices united by the
            power of storytelling. Our mission is to inspire, connect, and
            empower every individual to make their mark on the world
          </p>
          <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10 dark:text-gray-300">
            At the heart of our platform is a commitment to inclusivity and
            innovation. With a growing community of 400k users, we provide a
            dynamic space for individuals to express themselves freely and
            connect with like-minded creators. Our mission is clear: to
            democratize storytelling, making it accessible to all, and to
            empower every individual to share their unique perspective and leave
        ...
        <div className="w-full lg:w-6/12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
            ...
            <div className="flex p-4 shadow-md">
              ...
              <div className="">
                <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 dark:text-gray-100">
                  Team
                </p>
