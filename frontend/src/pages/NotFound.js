...
export const NotFound = () => {
  return (
    <div className="h-screen w-full bg-gray-50 dark:bg-gray-800 flex items-center">
      <div className="container flex flex-col md:flex-row items-center justify-between px-5 text-gray-700 dark:text-gray-100 ">
