...
import { addExperince } from "../../store/usersSlice";
import { useToast } from "@chakra-ui/react";

function AddEperienceModal({ setShow }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch("http://localhost:4000/api/users/addWork", {
      method: "POST",
      headers: {
...
export default AddEperienceModal;
