...
function Team() {
  return (
    <div className="font-[sans-serif] text-[#333] bg-gray-50 dark:bg-gray-700 py-20 border-t dark:text-gray-100">
      <div className="lg:max-w-7xl max-w-2xl mx-auto p-4">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-8 max-md:justify-center mt-12">
          <div className="flex items-center max-sm:flex-col">
            ...
            <div className="p-4 sm:ml-4">
              <h4 className="text-base font-extrabold">
                Mohamed Amine Benomar
              </h4>
              <p className="text-xs mt-1">Software Engineer</p>
              <div className="mt-4">
                <p className="text-sm leading-relaxed">
                  I love coding and motorcycles, i code for fun
                </p>
              </div>
          ...
          <div className="flex items-center max-sm:flex-col">
            ...
            />
            <div className="p-4 sm:ml-4">
              <h4 className="text-base font-extrabold">Ibtissam M'ghrabi</h4>
              <p className="text-xs mt-1">Graphic Designer | Web Designer</p>
              <div className="mt-4">
                <p className="text-sm leading-relaxed">
                  I am a lovely person ,i love kids and design
                </p>
              </div>
              <div className="space-x-4 mt-4">
                <button
